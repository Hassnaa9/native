...
@objc public class Vec2Wrapper: NSObject {
    ...
    @objc public init(x: Double, y: Double) {
        self.wrappedInstance = Vec2(x: x, y: y)
    }

    public static func +(lhs: Vec2Wrapper, rhs: Vec2Wrapper) -> Vec2Wrapper {
        let result = lhs.wrappedInstance + rhs.wrappedInstance
        return Vec2Wrapper(result)
    }

    public static func ==(lhs: Vec2Wrapper, rhs: Vec2Wrapper) -> Bool {
        return lhs.wrappedInstance == rhs.wrappedInstance
    }

    public static func ***(lhs: Vec2Wrapper, rhs: Vec2Wrapper) -> Double {
        return lhs.wrappedInstance *** rhs.wrappedInstance
    }
}
